...
with st.form(key='my_form'):
    ...
    if submit_button:
       ...
       'PAPERTYPE_KT3', 'KENH_AGENT E2E', 'KENH_Agent', 'KENH_DRS', 'KENH_E2E',
       'KENH_KDML', 'KENH_Recall E2E', 'LOAI_KHACH_HANG_Cá nhân',
       'LOAI_KHACH_HANG_Tổ chức', 'LOAI_HINH_CU_TRU_Cư Trú',
       'LOAI_HINH_CU_TRU_Thường Trú', 'LOAI_HINH_CU_TRU_Tạm Trú',
       'MARITAL_STATUS_Chưa có gia đình', 'MARITAL_STATUS_Có gia đình',
       'MARITAL_STATUS_Góa phụ', 'MARITAL_STATUS_Li dị chưa con',
       'MARITAL_STATUS_Li dị có con', 'MARITAL_STATUS_UnKnown',
       'JOB_NM_Bác sĩ/Kỹ sư', 'JOB_NM_Bán hàng', 'JOB_NM_Bảo vệ',
       'JOB_NM_Công nhân/Thợ', 'JOB_NM_Giúp việc/Tạp vụ/ Vệ sinh',
       'JOB_NM_Không xác định', 'JOB_NM_Nhân viên văn phòng',
       'JOB_NM_Quản lý/Chủ Doanh nghiệp',
       'JOB_NM_Quân đội/Công An/Viên chức nhà nước', 'JOB_NM_Sinh viên',
       'JOB_NM_Tài xế công nghệ', 'JOB_NM_Tài xế công nghệ/Shipper',
       'JOB_NM_Thợ làm tóc/trang điểm/Spa', 'JOB_NM_Thợ may',
       'JOB_NM_Thợ xây/ sửa chữa/cơ khí…', 'JOB_NM_Tiểu thương buôn bán',
